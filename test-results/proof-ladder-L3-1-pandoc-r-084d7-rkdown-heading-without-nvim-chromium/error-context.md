...
- Name: proof-ladder.spec.ts >> L3.1 pandoc_renders_markdown_heading_without_nvim
- Location: tests/proof-ladder.spec.ts:221:1

# Error details

```
Error: pandoc exit code must be 0; stderr=
