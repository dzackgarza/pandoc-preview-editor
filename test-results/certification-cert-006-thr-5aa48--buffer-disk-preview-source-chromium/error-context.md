...
- Name: certification.spec.ts >> cert_006 three-way source equivalence: nvim buffer = disk = preview source
- Location: tests/certification.spec.ts:444:1

# Error details

```
Error: Command failed: nvim --server /tmp/pandoc-nvim-preview/nvim.sock --remote-send GA<Esc>
